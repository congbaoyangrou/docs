...
返回的 JSON 对象会包含 updatedAt 和 objectId 字段，表明更新发生的时间和被更新对象的ID：

```json
{
  "updatedAt": "2015-06-30T18:02:52.248Z",
  "objectId": "6150125bbeca42096ebc98c9"
}
```
...
**username 、 email 和 mobilePhoneNumber 这三个字段必须是没有重复的（username大小写敏感）。**
...
比如，为了限制一个对象可以被在 Staff 里的任何人读到，而且可以被它的创建者和任何有 Manager 角色的人所修改，你应该像下面这样设置 ACL：
